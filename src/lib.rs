...
#[derive(Debug)]
pub struct UltraProtoProcessor {
    verbose: bool,
    processed_count: usize,
}

impl UltraProtoProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting UltraProto processing");
    
    let mut processor = UltraProtoProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = UltraProtoProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = UltraProtoProcessor::new(false);
